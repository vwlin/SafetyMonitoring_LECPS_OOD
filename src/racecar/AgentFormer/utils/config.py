...
class Config:
    ...
    def __init__(self, cfg_id, dataset_seed=None, tmp=False, create_dirs=False):
        self.id = cfg_id
        ...
        if dataset_seed is not None:
            self.dataset_mode = f'{self.dataset_mode}_s{str(dataset_seed)}'
            self.cfg_root_dir = f'{self.cfg_root_dir}_s{str(dataset_seed)}'
