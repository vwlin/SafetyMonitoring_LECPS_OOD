...
class preprocess(object):
    ...
    def __init__(self, data_root, seq_name, parser, log, split='train', phase='training'):
        ...
        self.dataset_mode = parser.dataset_mode
        ...
        if parser.dataset == 'nuscenes_pred':
            ...
            label_path = f'{data_root}/{parser.dataset_mode}/{seq_name}.txt'
            delimiter = ' '
        else:
            assert False, 'error'
        ...
        self.gt = self.gt.astype('float64') # must use float64 if IDs are really large
