# code and pretrained agent from https://blog.gofynd.com/building-a-deep-q-network-in-pytorch-fa1086aa5435
...
class DQN_Agent:
    ...
    def load_pretrained_model(self, model_path):
        ...
        self.q_net.load_state_dict(torch.load(model_path, map_location=torch.device('cpu')))
